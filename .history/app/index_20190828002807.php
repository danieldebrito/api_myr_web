...
$app->group('/usuarios', function () {
  $this->get('/', \usuarioApi::class . ':readAllApi');
  $this->get('/{id_usuario}', \usuarioApi::class . ':readApi');
  $this->post('/', \usuarioApi::class . ':createApi');
  $this->delete('/{id_usuario}[/]', \usuarioApi::class . ':deleteApi');
  $this->post('/update', \usuarioApi::class . ':updateApi');
});
